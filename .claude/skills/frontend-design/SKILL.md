...
description: Guidance for distinctive, intentional visual design when building new UI or reshaping an existing one. Helps with aesthetic direction, typography, palette, and making choices that don't read as templated defaults.
...
bg-page: Light #F3F5F1 | Dark #121212

bg-surface: Light #FFFFFF | Dark #1E1E1E

text-primary: Light #1C1F1D | Dark #F2E8DC

text-muted: Light #5B615C | Dark #B8A58E

border: Light #D8DBD3 | Dark #2D2D2D

accent: Light #2B4F44 | Dark #6981EC

accent-on: Light #FFFFFF | Dark #17120D

string-line: Light #A8ADA6 | Dark #525252

logo-plate: Light #FFFFFF | Dark #EDD9BC
